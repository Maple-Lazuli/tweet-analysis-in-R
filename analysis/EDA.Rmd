...
```{r, out.width = '100%', warning=FALSE, message=FALSE}
tweets <- read.csv("../data/tweets_prepped.csv")
```
...
ggplot(count_df, aes(x = label, y = ratio, fill = label)) + geom_col(alpha = 0.3) + labs(title = "Normalized Comparison of URL Occurrences", x = "Label", y = "Percentage With URLs")
```
